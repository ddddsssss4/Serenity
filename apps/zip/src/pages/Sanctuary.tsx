      ...
      <section className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          <div className="bg-secondary-container rounded-[2rem] p-6 space-y-4">
            ...
            <Link to="/reflection" className="inline-block text-primary font-medium text-sm hover:underline">
              Start Reflection &rarr;
            </Link>
          </div>

          <div className="grid grid-cols-2 gap-4">
            <Link to="/journal" className="bg-surface-container-highest rounded-3xl p-6 flex flex-col items-center justify-center gap-3 hover:bg-surface-variant transition-colors group">
            ...
            <Link to="/reflection" className="bg-surface-container-highest rounded-3xl p-6 flex flex-col items-center justify-center gap-3 hover:bg-surface-variant transition-colors group">
